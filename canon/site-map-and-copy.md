...
## Page map (single-page v1)
1. Hero (Buy + Updates)
2. What it is (10-second clarity)
3. How it works (simple mechanism)
4. What it supports (use cases)
5. Founder note (trust + why)
6. FAQ (friction killers)
7. Buy block (shipping/returns/cleaning)
8. Final CTA
...
### Headline
Make the breath easier to feel.
...
### Simple 3-step (copy)
1. **Breath becomes more vivid.** Still Point increases the felt signal at the nostrils.  
2. **Attention returns more easily.** When the mind drifts, sensation makes the return simpler.  
...
### Intro line
A simple tool for meditation, transitions, and sleep wind-down—any time you want to come back to the breath.

### Use case cards (headlines + 1 line each)
- **Meditation** — helps the breath feel easier to follow during sits.
...
### Section heading
Why I made Still Point

### Copy (short)
I built Still Point because I kept seeing the same challenge: people want to rest attention on the breath, but the breath can feel subtle—especially when the mind is busy. Still Point is a small, gentle way to amplify what’s already there. No tech. No performance pressure. Just a quiet companion that helps you return.
...
### Q: Is it a nasal dilator?
No. Still Point is not designed to open the airway or change breathing. It’s a breath-awareness tool.

### Q: Will it fit my nose?
Still Point is designed to rest securely by contour fit on the outer nasal sidewalls. (If you later offer sizes: add sizing guidance here.)

### Q: How do I wear it?
Place it gently on the nose so it rests on the outer sidewalls. It should feel stable and comfortable, not pinching.

### Q: Can I talk while wearing it?
Yes. It’s designed to be unobtrusive and to leave the mouth and lip movement free.

### Q: How long do I wear it?
As long as it feels comfortable—many people use it for a full meditation session or during wind-down.

### Q: Can I use it for sleep?
Many people use it at bedtime as a breath anchor. Comfort varies by person. Use what feels safe and comfortable for your body.

### Q: How do I clean it?
Wash with mild soap and warm water, rinse well, and let it fully dry.

### Q: Is this a medical device?
No. Still Point is not a medical device and is not intended to diagnose, treat, cure, or prevent any disease.

---

## 7) Buy block (checkout support)
...
### Closing line
A small tool. A clearer breath. A calmer return.
...
## Notes for implementation (v1)
- Keep it single-page. Keep it calm. Keep it visual.
- Use real photos: on-face + close-up in hand.
- Keep disclaimers minimal but present (FAQ and/or footer).
- Place “Buy Now” and “Get Updates” in hero and again near the end.
